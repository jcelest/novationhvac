...
function MedallionFrame({ idPrefix, children }) {
  return (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
      ...
      <circle cx="24" cy="24" r="17.5" fill={`url(#${idPrefix}-inner)`} stroke="rgba(253, 230, 138, 0.35)" strokeWidth="1" />
      {children}
      <defs>
  ...
  return (
    <MedallionFrame idPrefix="heroBadgeLicensed">
      <path
        ...
        fill="url(#heroBadgeShieldPurple)"
        stroke="#fde68a"
        strokeWidth="1.25"
      />
      <path d="M20 22.5 23 25.5 29 19.5" stroke="#fde68a" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" />
      <defs>
        <linearGradient id="heroBadgeShieldPurple" x1="16" y1="11" x2="32" y2="33" gradientUnits="userSpaceOnUse">
...
function SameDayIcon() {
  return (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
      ...
      <circle cx="24" cy="24" r="17.5" fill="url(#heroBadgeGoldDiscInner)" stroke="rgba(255, 255, 255, 0.25)" strokeWidth="1" />
      <path
...
function EmergencyIcon() {
  return (
    <MedallionFrame idPrefix="heroBadgeEmergency">
      <circle cx="24" cy="24" r="9.5" stroke="rgba(253, 230, 138, 0.45)" strokeWidth="1.25" />
      <path d="M24 17v7.5l5 3.2" stroke="#fde68a" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15 13.5a15 15 0 0 0-1.5 3.5M33 13.5a15 15 0 0 1 1.5 3.5" stroke="#c4b5fd" strokeWidth="1.75" strokeLinecap="round" />
...
function StarRatingIcon() {
  return (
    <svg viewBox="0 0 48 48" fill="none" aria-hidden="true">
      ...
      <circle cx="24" cy="24" r="17.5" fill="url(#heroBadgeStarDiscInner)" stroke="rgba(255, 255, 255, 0.2)" strokeWidth="1" />
      <path
