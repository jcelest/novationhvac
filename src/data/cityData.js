export const orlandoData = {
  ...
  heroTagline: 'Same-day when available · 24/7 emergencies · full system changeouts when you need them',
  aboutTitle: 'Orlando HVAC from a Central Florida team you can trust',
  aboutSubtitle: 'Repairs first; replacements & installs when they make sense',
  aboutPara1:
    'Novation Heating and Air Conditioning is headquartered in Poinciana; we dispatch licensed crews across Central Florida every day—including throughout Orlando. From Baldwin Park to MetroWest, Dr. Phillips to the I-4 corridor, we handle central air and heat pump repair, furnace work, new system sizing, duct concerns, and after-hours emergencies when your cooling quits on a packed schedule.',
  aboutPara2:
    'You get background-checked technicians, upfront explanations before work begins, and financing options when it is time to replace equipment. For a same-day slot when available, routine tune-ups, or a second opinion on a major repair, call (407) 973-1523 or book an appointment online.',
  serviceIntro:
    'Orlando homeowners call us for everything from quick capacitor fixes to full-system changeouts. Same-day service when our schedule allows; 24/7 line for true emergencies.',
  seoContent: {
    h2: 'Why Orlando homeowners choose Novation',
    paragraphs: [
      'Orange County weather swings from humid summers to chilly winter nights—your HVAC has to keep up. We focus on accurate diagnostics so you are not sold parts you do not need, and we document options when a repair is only a short-term fix compared with a high-efficiency replacement.',
      'We regularly work near downtown Orlando, College Park, Winter Park, and the attractions corridor—traffic and tight schedules are normal for us. Tell us if you have a townhome, a historic bungalow, or a newer build; we adapt to access, thermostat setups, and HOA rules when they apply.',
      'Ask about indoor air quality add-ons if allergies or dust are an issue—filtration and humidity control can pair with your existing ducted system in many Orlando homes.',
    ],
    faqs: [
      { q: 'Do you offer same-day AC repair in Orlando?', a: 'We offer same-day service when technician availability allows—call early, especially in peak summer. True emergencies can reach our 24/7 line at (407) 973-1523.' },
      { q: 'Is Novation licensed for HVAC work in Orlando?', a: 'Yes. Florida license CAC1823924. We are bonded and insured for residential and light commercial work we accept.' },
      { q: 'Where is Novation based?', a: 'Our home base is Poinciana; we serve Orlando, Winter Haven, Lakeland, and the broader Central Florida region from that operation.' },
    ],
  },
};
...
export const kissimmeeData = {
  ...
  heroTagline: 'From downtown Kissimmee to the tourist corridor—same-day when available',
  aboutTitle: 'Trusted HVAC in Kissimmee & the US-192 Corridor',
  aboutSubtitle: 'Repair-first dispatch; installs when equipment is at end of life',
  aboutPara1:
    'Novation serves Kissimmee as a distinct market from our Poinciana home base and from the broader Osceola County page. We handle AC repair, heat pump issues, furnace calls, and new equipment for homes and rentals along US-192, the Disney-area corridor, and traditional Kissimmee neighborhoods. Licensed (CAC1823924), bonded, and insured.',
  aboutPara2:
    'Hot weather and high occupancy mean fast turnaround matters. Ask about maintenance before peak season, or financing when you need a full replacement. Call (407) 973-1523 or book online.',
  serviceIntro:
    'Kissimmee calls often include split systems in dense housing and older inventory—our team matches parts and labor to the property, not a generic checklist.',
  seoContent: {
    h2: 'Kissimmee HVAC — corridor & local coverage',
    paragraphs: [
      'This page targets Kissimmee proper and the 192 corridor—not the county-wide Osceola landing and not Poinciana’s home-base story. We focus on repair response times and honest equipment assessments.',
      'We regularly work near Old Town, Celebration-adjacent routes, and residential pockets off Neptune Road. Installations and heat pump changeouts are quoted when repairs are no longer economical.',
      'For emergency no-cool situations, call (407) 973-1523—same-day when trucks are available.',
    ],
    faqs: [
      { q: 'Do you offer AC repair in Kissimmee?', a: 'Yes. We provide full AC repair, cooling repair, and HVAC services throughout Kissimmee and Osceola County.' },
      { q: 'Is 24/7 emergency HVAC available in Kissimmee?', a: 'Yes. Our Kissimmee HVAC team offers 24-hour emergency cooling repair and furnace repair.' },
      { q: 'What areas near Kissimmee do you serve?', a: 'We serve Kissimmee, St. Cloud, Celebration, Poinciana, Orlando, and all of Osceola County.' },
    ],
  },
};
...
export const poincianaData = {
  ...
  heroTagline: 'Local dispatch, full HVAC & emergency service for 34759 and neighbors',
  aboutTitle: 'Your Poinciana HVAC team—right here in 34759',
  aboutSubtitle: 'Repairs & tune-ups; replacements when you are ready',
  aboutPara1:
    'Novation Heating and Air Conditioning is based in Poinciana—this is where we stage trucks, parts, and scheduling for the wider region. For neighbors in 34759, that means shorter drive times when you need a quick fix, a preseason tune-up, or a full system replacement. We work throughout Village 7, Crescent Lakes, and the broader Poinciana area, plus nearby Kissimmee and Polk-line communities when you refer family across the county line.',
  aboutPara2:
    'Florida heat does not negotiate—neither should your comfort. Ask about maintenance agreements to catch weak capacitors and dirty coils before they become a Friday-night emergency. Ready to talk? Call (407) 973-1523 or use online booking; mention if you need same-day priority.',
  serviceIntro:
    'Cooling repair, furnace and heat pump service, indoor air quality, and new installs—we handle the full stack for Poinciana homes.',
  seoContent: {
    h2: 'Why Poinciana homeowners start with Novation',
    paragraphs: [
      'Because we live and work from this zip code, we understand how split systems behave in local humidity, how older R-22 equipment is aging out, and when a duct issue is masquerading as “weak cooling.” We will walk you through repair-versus-replace math in plain language.',
      'Zip-to-zip, your neighbors often ask about air balance in two-story plans or add-on rooms—we can recommend zoning or supplemental dehumidification when it fits your budget and layout.',
      'Emergency line: if the house will not cool and you have pets, kids, or vulnerable adults at home, call (407) 973-1523—we prioritize true no-cool situations when capacity allows.',
    ],
    faqs: [
      { q: 'Is Novation really based in Poinciana?', a: 'Yes. Poinciana is our operational home base; we also dispatch to Orlando, Winter Haven, Lakeland, and other Central Florida areas from here.' },
      { q: 'Do you offer financing for new systems in Poinciana?', a: 'We can review flexible financing on qualifying equipment replacements—ask during your estimate.' },
      { q: 'What if I am on the Polk side of Poinciana?', a: 'We routinely serve Osceola and Polk sides of the community—tell us your cross streets when you call so we route the right truck.' },
    ],
  },
};

// Helper to create city data from template
const createCityData = (name, slug, options = {}) => ({
  ...
  aboutTitle: options.aboutTitle || `Trusted HVAC Company Serving ${name}, Florida`,
  aboutSubtitle: options.aboutSubtitle || `AC Repair, Heating & Cooling Services in ${name}`,
  ...
  seoContent: {
    ...
    paragraphs: options.seoParagraphs || [
      `Need AC repair ${name} or HVAC near me ${name}? Novation Heating and Cooling is Central Florida's trusted choice for cooling repair, furnace repair, and HVAC installation. 24/7 emergency AC repair available.`,
      `Heating and cooling ${name} — we serve ${name} and surrounding areas. From central air repair and heat pump installation to HVAC maintenance plans, our licensed technicians deliver quality cooling repair when you need it.`,
      `Emergency HVAC ${name}: When your AC fails in the Florida heat, our 24-hour AC repair team responds. Free estimates, transparent pricing, flexible financing. The HVAC contractors ${name} families trust.`,
    ],
    faqs: options.faqs || [
      { q: `Do you offer AC repair in ${name}?`, a: `Yes. We provide full AC repair, cooling repair, and HVAC services throughout ${name} and Central Florida.` },
      { q: 'Is 24/7 emergency HVAC available?', a: 'Yes. Our HVAC team offers 24-hour emergency cooling repair and furnace repair.' },
...
export const winterHavenData = createCityData('Winter Haven', 'winter-haven', {
  ...
  heroTagline: 'Chain of Lakes area—repair & no-cool calls first; replacements when needed',
  aboutTitle: 'Winter Haven HVAC Services',
  aboutSubtitle: 'Chain of Lakes area · repair-first response',
  seoH2: 'Winter Haven HVAC—how we help Polk County homes',
  seoParagraphs: [
    'Operating from Poinciana, we route technicians into Winter Haven weekly for everything from no-cool calls after a storm to heat-pump defrost issues in January. You get the same licensed team we send to Lakeland and Auburndale—consistent workmanship, not a random subcontractor rotation.',
    'Lakefront and inland homes both deal with humidity control challenges; we look at airflow, filter sizing, and drain lines—not just the thermostat reading—before we recommend a costly compressor swap.',
    'Light commercial rooftop units near US-17? Ask—we take select small-business jobs when capacity allows; call with your tonnage and access details.',
  ],
  aboutPara1:
    'Novation is based in Poinciana and runs daily routes into Winter Haven and the rest of Polk County. Whether you are near the Chain of Lakes, Cypress Gardens Boulevard, or quieter residential streets, we bring AC repair, heating service, replacements, and 24-hour emergency support to your door—no walk-in lobby, just trucks stocked for common parts.',
  aboutPara2:
    'Older R-410A splits and newer inverter systems both land on our schedule—tell us your equipment age when you call so we plan the right tools. To book maintenance before peak summer, or to get a tech rolling today, dial (407) 973-1523 or reserve a slot online.',
  serviceIntro:
    'Winter Haven calls span lake-adjacent humidity loads, rental turnovers, and light commercial rooftops—we match the visit to the job, not a script.',
  faqs: [
    {
      q: 'Do you offer AC repair in Winter Haven?',
      a: 'Yes. We provide cooling repair, furnace service, and full HVAC throughout Winter Haven and Polk County.',
    },
    {
      q: 'Is 24/7 emergency HVAC available in Winter Haven?',
      a: 'Yes. Call (407) 973-1523 for after-hours and emergency cooling or heating issues.',
    },
    {
      q: 'Do you also serve Lakeland and other Polk County cities?',
      a: 'Yes. We dispatch across Polk County including Lakeland, Auburndale, and Haines City. See our service areas for details.',
    },
  ],
});
...
export const allCityData = {
  ...
  'winter-haven': winterHavenData,
  auburndale: auburndaleData,
  'haines-city': hainesCityData,
  'dr-phillips': drPhillipsData,
  windermere: windermereData,
  'altamonte-springs': altamonteSpringsData,
};
